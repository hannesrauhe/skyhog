	...
	<section id="main_container" style="padding:10px">
		...
		<form method="post" action="save.target.php" id="content_form">
			<div>	
				...
				<div>
					<textarea id="elm1" name="elm1" rows="40" cols="180" style="width: 80%" enctype="multipart/form-data"><?php echo htmlentities(file_get_contents ($s->getPreviewDir().$file), ENT_QUOTES, "UTF-8"); ?></textarea>
				</div>	
